...
export default function BuyingProcess({ data }) {
  return (
        ...
        <div className="relative flex flex-col lg:flex-row items-center">
          <div className="lg:max-w-203 w-full bg-[#F8F7F4] lg:absolute lg:left-0 lg:top-1/2 lg:-translate-y-1/2 p-6 md:p-12 border-l-4 border-l-secondary z-10 shadow-lg lg:shadow-none mb-8 lg:mb-0">
            ...
            <p className="text-xl md:text-3xl font-normal text-[#343E56] mt-3">
              {data?.sub_title || "Your Dream Home Awaits"}
            </p>
            <p
          ...
          <div className="lg:ml-auto max-w-full lg:max-w-147 w-full h-80 md:h-125 lg:h-212 overflow-hidden rounded-lg shadow-xl">
            <Image
              src={data?.image || procesImg}
              alt="procesImg"
              width={588}
              height={848}
