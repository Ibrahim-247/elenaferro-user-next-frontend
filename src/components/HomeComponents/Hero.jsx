    ...
    >
      <Container>
        <div className="text-white flex flex-col items-center justify-center h-130 lg:h-175 space-y-3 lg:space-y-5">
          <h1 className="text-4xl sm:text-5xl lg:text-8xl text-center font-semibold font-cormorant uppercase">
            {data?.title || "Title"}
          </h1>
          <p className="text-xl sm:text-2xl lg:text-4xl font-light uppercase">
