...
export default function SellingGuideForm() {
  ...
  const onSubmit = () => {
    ...
    setTimeout(() => {
      ...
      link.href = "/pdf/Medlock%20Realty%20Seller's%20Guide%202.pdf";
      link.download = "Medlock_Realty_Sellers_Guide.pdf";
    ...
    <section className="w-full bg-[#F9F8F5] py-20 overflow-hidden">
      <Container>
        ...
        >
          ...
          >
            <p>
              Selling your home can be a complex and emotional process. That's
              why we’ve created a comprehensive seller's guide to help you
              navigate the process with ease. Whether you' re a first-time
              seller or a seasoned pro, our guide is packed with valuable
              information that will help you make informed decisions every step
              of the way.
            </p>
            <p>
